...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/address-options', [AddressOptionsController::class, 'store'])->name('address_options.store');
    Route::delete('/address-options/{id}', [AddressOptionsController::class, 'destroy'])->name('address_options.destroy');
